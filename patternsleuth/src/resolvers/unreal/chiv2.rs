...
// FIXME: ←[31mMsg("found 2 unique values [1419E5EB0, 141A8A1F0]")←[0m
...
// FIXME: ←[31mMsg("expected at least one value")←[0m
/// public: void __cdecl FFrame::Step(class UObject *, void *const)
#[derive(Debug, PartialEq)]
#[cfg_attr(
    feature = "serde-resolvers",
...
// FIXME: ←[31mMsg("found 3 unique values [1419B4AD0, 1423D71B0, 1423D7BA0]")←[0m
/// public: void __cdecl FFrame::Step(class UObject *, void *const)
#[derive(Debug, PartialEq)]
#[cfg_attr(
    feature = "serde-resolvers",
...
impl_resolver_singleton!(all, UTBLLocalPlayer_Exec, |ctx| async {
    let patterns = [
        ...
        "4C 89 4C 24 20 4C 89 44 24 18 48 89 54 24 10 55 53 56 57 41 54 41 55 41 56 41 57 48 8B EC 48 83 EC 68"
    ];
...
impl_resolver_singleton!(all, FText_AsCultureInvariant, |ctx| async {
    let patterns = [
        "48 89 5C 24 18 48 89 74 24 20 41 56 48 83 EC 60 33 C0 48 89 7C 24 78 48 63", // EGS
